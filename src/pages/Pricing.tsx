      ...
      <main className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground mb-6">Choose the plan that works best for you</p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            {/* Yearly Plan */}
            <div className="border rounded-lg p-8 bg-primary text-white shadow-lg transform scale-105">
              ...
              <p className="text-sm mb-4 text-primary-foreground/80">Billed annually ($89.88/year)</p>
              <ul className="space-y-3 mb-8">
          ...
          <div className="mt-16 text-center">
            <div className="max-w-2xl mx-auto bg-muted p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-2">🚀 Beta Access</h3>
