...
const AmazonIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" {...props}>
    <path fill="#FF9900" d="M24.707,7.189c0-1.467,0.137-2.669,0.384-3.572c0.274-0.94,0.646-1.889,1.126-2.837 c0.137-0.274,0.11-0.549-0.083-0.823C25.89-0.317,25.561-0.427,25.151-0.427c-0.329,0-0.74,0.165-1.26,0.494 c-1.778,1.095-3.283,2.724-4.489,4.926c-1.205,2.202-1.807,4.241-1.807,6.133v2.226c0,0.302,0.164,0.521,0.494,0.659 c0.329,0.137,0.63,0.083,0.906-0.165c0.933-0.823,1.697-1.451,2.284-1.889c0.587-0.438,1.36-0.878,2.311-1.316L24.707,7.189z"/>
  </svg>
);
...
const MetaIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" {...props}>
    <path fill="#0866FF" d="M50 0C22.4 0 0 22.4 0 50s22.4 50 50 50 50-22.4 50-50S77.6 0 50 0zm0 75c-13.8 0-25-11.2-25-25s11.2-25 25-25 25 11.2 25 25-11.2 25-25 25z"/>
  </svg>
);
