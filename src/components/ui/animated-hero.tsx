...
function AnimatedHero() {
  ...
  const titles = useMemo(
    () => ["Gets You Hired", "Beats the ATS", "Stands Out", "Lands Interviews", "Recruiters Love"],
    []
  );
        ...
        <div className="flex gap-6 py-12 lg:py-24 items-center justify-center flex-col">
          ...
          <div className="flex gap-4 flex-col">
            <h1 className="text-5xl md:text-7xl max-w-2xl tracking-tighter text-center font-regular">
              <span className="text-primary">Create a Resume That</span>
            ...
            <p className="text-lg md:text-xl leading-relaxed tracking-tight text-muted-foreground max-w-2xl text-center">
              Stop getting rejected by bots. Our AI-powered builder creates professional, ATS-optimized resumes that get you hired 3x faster.
            </p>
          </div>
          <div className="flex flex-col gap-8 items-center">
            <Link to="/signup">
              <RainbowButton className="gap-4">
                Build Your Free Resume <MoveRight className="w-4 h-4" />
              </RainbowButton>
            </Link>
