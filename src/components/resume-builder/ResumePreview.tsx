        ...
        <div className="relative w-full" style={{ aspectRatio: '210/297' }}>
          <ScrollArea className="absolute inset-0">
            <div className="p-8 md:p-12 h-full">
              <div className={cn("mb-6 md:mb-8", style.headerStyle)}>
                <h1 className={cn("text-2xl md:text-4xl mb-3 md:mb-4", style.titleFont)}>
                  <EditableText text={personalInfo.fullName} section="personalInfo" field="fullName" />
                </h1>
                <div className="mb-3 md:mb-4">
                  <h2 className={cn("text-lg md:text-2xl text-gray-600", template.id === "modern-split" ? "uppercase tracking-wide" : "")}>
